...
article_types = {u'开发语言': ['Python', 'Java', 'C++'],
                 'Linux': [u'Linux成长之路', 'Ubuntu'],
                 u'数据库': ['MySQL'],
                 u'爱生活，爱自己': [u'吐槽'],
                 u'Web开发': ['Flask'],}
...
class Comment(db.Model):
    ...
    reply_to = db.Column(db.String(128), default='-1')
...
class Article(db.Model):
    ...
    def prints(self):
        return markdown(self.content,encoding="utf-8", output_format='html5')
...
class BlogInfo(db.Model):
    ...
    def insert_blog_info():
        blog_mini_info = BlogInfo(title=u'Mika Blog',
                                  signature=u'Beta 1.0',
                                  navbar='inverse')

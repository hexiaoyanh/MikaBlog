...
from mikablog import create_app, db
from mikablog.models import ArticleType, article_types, \
...
def deploy(deploy_type):
    ...
    from mikablog.models import BlogInfo, User, ArticleTypeSetting, \
    ...
    if deploy_type == 'product':
        ...
        User.insert_admin(email='heiaoyang@foxmail.com', username='Mika', password='he18390163412')
